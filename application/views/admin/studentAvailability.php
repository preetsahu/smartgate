...
<script type="text/javascript">
    ...
    function showStudents(){
                           ...
                           success: function(data)
                           {
                               ...
                               {
                                   html +='<tr>'+
                                       '<td><label class="label label-primary">'+data[i].PRESENCE_STATUS+'</label></td>'+
                                       '<td>'+data[i].FIRST_NAME+' '+data[i].LAST_NAME+'<br/><small>Student ID:-'+data[i].STUDENT_ID+' || '+data[i].DEPARTMENT_NAME+'</small></td>'+
                                       '<td>'+data[i].MOBILE_NUMBER+'</td>'+
                                       '<td>'+data[i].EMAIL_ID+'</td>'+
                                       '<td class="project-actions"><a href="<?=base_url('Student-Activity-View')?>?SID='+data[i].STUDENT_ID+'" class="btn btn-white btn-sm"><i class="fa fa-folder"></i> View Complete Activity</a></td>'+
                                       '</tr>';
                               }
                               $('#showD').html(html);
                           },
