            ...
            <div class="container padding-top-3x">
              <div class="row justify-content-center align-items-center">
                <div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
                  <div class="from-bottom"><img class="d-inline-block w-150 mb-4" src="<?= base_url()?>assets/img/hero-slider/logo02.png" alt="Puma">
                ...
                <div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="<?= base_url()?>assets/img/hero-slider/02.png" alt="Puma Backpack"></div>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="container padding-top-3x">
              <div class="row justify-content-center align-items-center">
                <div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
                  <div class="from-bottom"><img class="d-inline-block w-200 mb-4" src="<?= base_url()?>assets/img/hero-slider/logo01.png" alt="Converse">
                ...
                <div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="<?= base_url()?>assets/img/hero-slider/01.png" alt="Chuck Taylor All Star II"></div>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="container padding-top-3x">
              <div class="row justify-content-center align-items-center">
                <div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
                  <div class="from-bottom"><img class="d-inline-block mb-4" src="<?= base_url()?>assets/img/hero-slider/logo03.png" style="width: 125px;" alt="Motorola">
                ...
                <div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="<?= base_url()?>assets/img/hero-slider/03.png" alt="Moto 360"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6">
            <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                <div class="inner">
                  <div class="main-img"><img src="<?= base_url()?>assets/img/shop/categories/01.jpg" alt="Category"></div>
                  <div class="thumblist"><img src="<?= base_url()?>assets/img/shop/categories/02.jpg" alt="Category"><img src="<?= base_url()?>assets/img/shop/categories/03.jpg" alt="Category"></div>
                </div></a>
          ...
          <div class="col-md-4 col-sm-6">
            <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                <div class="inner">
                  <div class="main-img"><img src="<?= base_url()?>assets/img/shop/categories/04.jpg" alt="Category"></div>
                  <div class="thumblist"><img src="<?= base_url()?>assets/img/shop/categories/05.jpg" alt="Category"><img src="<?= base_url()?>assets/img/shop/categories/06.jpg" alt="Category"></div>
                </div></a>
              <div class="card-body text-center">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                <div class="inner">
                  <div class="main-img"><img src="<?= base_url()?>assets/img/shop/categories/07.jpg" alt="Category"></div>
                  <div class="thumblist"><img src="<?= base_url()?>assets/img/shop/categories/08.jpg" alt="Category"><img src="<?= base_url()?>assets/img/shop/categories/09.jpg" alt="Category"></div>
                </div></a>
              <div class="card-body text-center">
