            ...
            <div class="row animated fadeInRight">
                <div class="col-md-4">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-title">
                            <h5>Status:<?=$status ?>|Mobile:<?=$MOB ?></h5>
                        </div>
                        <div>
                            <div class="ibox-content no-padding border-left-right">
                                <img alt="image" class="img-responsive" src="<?=base_url()?>/assets/img/nitrr.jpg">
                            </div>
                            <div class="ibox-content profile-content">
                                <h4><strong>Preet Sahu</strong></h4>
                                <p><i class="fa fa-map-marker"></i> Raipur Chhattisgarh/492010</p>
                                <h5>
                                    About me
                                </h5>
                                <p>
                                    Currently Pursing Master of computer Application From National institute of technology Raipur. 
                                ...
                                <div class="user-button">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" class="btn btn-default btn-sm btn-block"><i class="fa fa-coffee"></i>Contact</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
