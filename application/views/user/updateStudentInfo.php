                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 ">
                                    <form role="form">
                                        ...
                                        <div>
                                            <button class="btn btn-sm btn-primary pull-left m-t-n-xs" type="submit"><strong> Update Details</strong></button><br><br><br><br>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-4 col-lg-10">
                                        <button class="btn btn-md btn-primary" type="submit" disabled>Update</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                                ...
                                <div class="row">
                                    ...
                                    <button class="btn btn-sm btn-primary pull-left m-t-n-xs" type="submit" disabled><strong> Update Details</strong></button><br><br><br><br>
                                    </div> 
                                </div>
                                </form>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5 b-r" style="">
                                 <form class="form"  id="frmPermanentAddress" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                                <button  class="btn btn-md btn-primary" id="btnPermanentAddressupdate">Update</button>
                                        </div>
                                    </div>   
                                ...
                                <form class="form" method="post" id="frmCurrentAddress">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                                <button class="btn btn-md btn-primary" id="btnCurrentAddressUpdate">Update</button>
                                        </div>
                                    </div>   
