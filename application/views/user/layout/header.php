                ...
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element"> <span>
                            <a href="" type="file"><img alt="image" class="img-circle" src="<?=base_url()?>/assets/img/logo.jpg"/></a>
                             </span>
                        ...
                        <div class="logo-element">
                          <img class="img img-responsive" src="<?=base_url()?>assets/admin/img/nitrr.jpg">
                        </div>
                    </li>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li>
                            <span class="m-r-sm text-muted welcome-message">Welcome User to Smart Gate .</span>
                        </li>
