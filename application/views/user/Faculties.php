                            ...
                            <div class="row m-b-sm m-t-sm">
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <input type="text" id="staffSearch" placeholder="Search by Name Or Department or Mobile Number" class="input-sm form-control"> <span class="input-group-btn">
