                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                   <a href="<?=base_url('QR-Download')?>" class="btn border-danger"><img alt="image" class="img img-responsive" style="width:100px;height:100px" src="<?=base_url()?>assets/RegisteredUserQR/<?=$user?>/<?=$qr?>/<?=$qr?>.png"></a>
                                </div>
                                <div class="col-md-3"></div> -->
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                   <a href="<?=base_url('QR-Download')?>" ><img alt="image" class="img img-responsive" style="width:100px;height:100px" src="<?=base_url()?>assets/RegisteredUserQR/<?=$user?>/<?=$qr?>/<?=$qr?>.png"></a>
                                   <a href="<?=base_url('QR-Download')?>" class="btn btn-primary btn-md"> Download </a>
                                </div>
                                <div class="col-lg-5">
